...
export class BudgetsService {
    ...
    async createOrUpdate(amount: number, month: string, year: number, currency: string, user: User): Promise<Budget> {
    ...
    async findCurrent(month: string, year: number, user: User): Promise<Budget | null> {
